...
const ChallengeState = () => {
    ...
    const { data: challengeStartTime, refetch: refetchStartTime } =
        useReadContract({
            address: contractAddress,
            abi: contractAbi,
            ...
            <div /*className="p-5 border"*/>
                {!IsPending &&
                    currentDisplayStatus ===
                        WorkflowStatus.GatheringPlayers && (
                        <div>
                ...
                {currentDisplayStatus === WorkflowStatus.OngoingChallenge && (
                    <OngoingChallenge
                        ...
                        refreshDisplay={refreshDisplayStatus}
                    />
                )}
                ...
                {!IsPending &&
                    !Object.values(WorkflowStatus).includes(
                        currentDisplayStatus,
                    ) && (
                        <p className="text-red-500">
                            {t("State.error_display")}
                        </p>
                    )}
            </div>
        </>
