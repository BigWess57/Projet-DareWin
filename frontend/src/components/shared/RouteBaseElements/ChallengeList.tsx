    ...
    const getChallengeEvents = async() => {     
        ...
        //FOR RECENT CHALLENGES
            ...
            if(process.env.NEXT_PUBLIC_DEFAULT_CHAIN === "hardhat"){
                challengesCreatedInfo = await buildChallengesObject(challengeCreatedAddresses);
                joinedChallengesInfo = await buildChallengesObject(joinedChallengesAddresses);
                latestChallengesInfo = await buildChallengesObject(latestChallengeAddresses);
                return;
            }
            ...
            latestChallengesInfo = await buildChallengesObject(mergedLatestAddresses);
            ...
            challengesCreatedInfo = await buildChallengesObject(mergedCreatedAddresses);
            ...
            joinedChallengesInfo = await buildChallengesObject(mergedJoinedAddresses);
