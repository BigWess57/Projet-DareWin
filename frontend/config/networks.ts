...
export const SUBGRAPH_URLS: Record<ChainKey, string> = {
    baseSepolia:
        "https://api.studio.thegraph.com/query/1704762/challenge-subgraph/version/latest",
...
export const uniswapV2RouterAddress: `0x${string}` =
    UNISWAP_V2_ROUTER[DEFAULT_CHAIN];
export const uniswapV2FactoryAddress: `0x${string}` =
    UNISWAP_V2_FACTORY[DEFAULT_CHAIN];
