...
export const TOKEN_ADDRESSES: Record<ChainKey, `0x${string}`> = {
  baseSepolia: "0x1B0dBd67C416EC91FB94862359c200129F5B6335",
...
export const FACTORY_ADDRESSES: Record<ChainKey, `0x${string}`> = {
  baseSepolia: "0xAfC2b14a40aFb10859f5DDDe49B1ea1c13eCAdD0",
...
export const SUBGRAPH_URLS: Record<ChainKey, string> = {
  baseSepolia: "https://api.studio.thegraph.com/query/1704762/challengesubgraph/v0.0.1",
  sepolia: "",
  holesky: "",
