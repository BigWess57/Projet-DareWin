...
contract Challenge is Ownable{
    ...
    /// @param _merkleRoot merkle root of addresses allowed
    constructor(address initialOwner, DareWin _tokenAddress, uint64 _duration, uint128 _bid, string memory _description, address _feeReceiver, bytes32 _merkleRoot, string memory _ipfsCid) Ownable(initialOwner) {
