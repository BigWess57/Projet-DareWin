...
async function main() {
    ...
    if (!ethers.isAddress(config.tokenAddress)) {
        throw new Error(
            "❌ Invalid DARE token address in environment variables",
        );
    }
    ...
    if (ethBalance < config.ethAmount) {
        throw new Error(
            `❌ Insufficient ETH balance. Required: ${ethers.utils.formatEther(
                config.ethAmount,
            )}, Found: ${ethers.formatEther(ethBalance)}`,
        );
    }
    console.log(
        `✅ ETH balance sufficient: ${ethers.formatEther(ethBalance)} ETH`,
    );
    ...
    if (tokenBalance < config.tokenAmount) {
        throw new Error(
            `❌ Insufficient DARE balance. Required: ${ethers.formatEther(
                config.tokenAmount,
            )}, Found: ${ethers.formatEther(tokenBalance)}`,
        );
    }
    console.log(
        `✅ DARE balance sufficient: ${ethers.formatEther(tokenBalance)} DARE`,
    );
    ...
    console.log(
        `Current allowance: ${ethers.formatEther(currentAllowance)} DARE`,
    );
    ...
    console.log(
        `Token Min (with slippage): ${ethers.formatEther(amountTokenMin)} DARE`,
    );
    console.log(
        `ETH Min (with slippage): ${ethers.formatEther(amountETHMin)} ETH`,
    );
